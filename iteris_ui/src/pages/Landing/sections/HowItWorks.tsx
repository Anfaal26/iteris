...
const STEPS = [
  ...
  { num: '02', title: 'Choose a Model',     description: 'Select DuelingDDQN (discrete) or TD3 (continuous) from the model library, or benchmark against the Attention U-Net baseline.' },
